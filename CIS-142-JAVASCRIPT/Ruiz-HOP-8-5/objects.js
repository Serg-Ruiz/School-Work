...
function piece(color, rank) {
   color = chessPiece.color();    // the color of the piece (white or black)
   rank = chessPiece.rank();      // the piece rank (Pawn, Knight, Bishop, Rook, Queen, King)
   square = chessPiece.square();    // the square the piece occupies
   image = chessPiece.image();     // stores the HTML code representing the image of the piece
}
