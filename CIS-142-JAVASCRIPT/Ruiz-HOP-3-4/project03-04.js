...
for (int i=0; < reviewers.length; i++)
{
      var reviewCode = "";
      ...
      reviewCode += "<caption>" + reviewTitles[i]+ "</caption>" + "<tr><th>By</th><td>"+reviewers[i]+"</td></tr>" + "<tr><td colspan = '2'>"+reviews[i]+"</td></tr>" + "</table>";


      document.getElementsByTagName("article")[0].insertAdjacentElement(reviewCode);
};
