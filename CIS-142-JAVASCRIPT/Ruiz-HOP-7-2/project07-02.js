...
//new deck function to make made using split method when there is a  sort using shuffle as comparison and shuffle function returning 0.5 minus randm num
...
for (let i =0;  i < cards.ChildNodes.length; i++ )
{
      ...
      cards[i].textContent = poppedCard;

      cardsLeft.textContent = deck.length;
}
}
// goes through cards node list and calls new deck if length is equal to zero makes cards node text equal to deck.pop()
// makes cards left text value equal deck length value
